...
import { ThreeDBackground, FloatingShapes } from "@/components/ui/3d-background";
import { MessageCircle, Search, FileText, CheckCircle, Wrench, FlaskConical, Package, Headphones, Unlock, Droplet, Cpu, HardDrive, Database, Shield } from "lucide-react";

const testimonials = [
  {
    quote: "I was amazed by the quick and efficient service for my water-damaged MacBook. The team restored it to perfect working condition, saving me from buying a new one. Highly recommended!",
    name: "Arjun",
    title: "Freelance Photographer",
    image: "https://i.ibb.co/r4g9Hbv/oie-v-KM22z-HFO6-SM-1-2.png"
  },
  {
    quote: "My iMac had storage issues, and the upgrade service was flawless. The team explained everything clearly, and now my device runs faster than ever. A fantastic experience!",
    name: "Priya",
    title: "Graphic Designer",
    image: "https://i.ibb.co/dP2jN76/oie-v-KM22z-HFO6-SM-1-1.png"
  },
  {
    quote: "The team successfully removed the MDM lock on my MacBook Pro. I was impressed by their professionalism and the secure handling of my device. Exceptional service!",
    name: "Rajesh",
    title: "App Developer",
  ...
  return (
    <section className="flex flex-col overflow-x-hidden">
      ...
      <div className="w-full relative py-8 sm:py-16 lg:py-24 lg:min-h-screen lg:flex lg:items-center bg-gradient-to-b from-violet-50/50 via-white to-white overflow-hidden">
          ...
          <div className="absolute top-[10%] sm:top-20 right-2 sm:right-10 bg-white/80 backdrop-blur-sm px-2 py-1.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-violet-200/50 pointer-events-none block">
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="text-left">
                <div className="text-[10px] sm:text-xs text-gray-500">MacBook</div>
                <div className="text-xs sm:text-sm font-bold text-gray-900">Expert Repair</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-[22%] sm:bottom-32 left-2 sm:left-10 bg-white/80 backdrop-blur-sm px-2 py-1.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-blue-200/50 pointer-events-none block">
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="text-left">
                <div className="text-[10px] sm:text-xs text-gray-500">iPhone/iPad</div>
                <div className="text-xs sm:text-sm font-bold text-gray-900">Quick Fix</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-[5%] sm:bottom-40 right-2 sm:right-16 bg-white/80 backdrop-blur-sm px-2 py-1.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-amber-200/50 pointer-events-none block">
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="text-left">
                <div className="text-[10px] sm:text-xs text-gray-500">Same Day</div>
                <div className="text-xs sm:text-sm font-bold text-gray-900">Fast Service</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-[60%] sm:top-[45%] right-6 sm:right-6 bg-white/80 backdrop-blur-sm px-2 py-1.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-purple-200/50 pointer-events-none block">
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="text-left">
                <div className="text-[10px] sm:text-xs text-gray-500">Original</div>
                <div className="text-xs sm:text-sm font-bold text-gray-900">Genuine Parts</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-20 sm:top-32 left-2 sm:left-16 bg-white/80 backdrop-blur-sm px-2 py-1.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-green-200/50 pointer-events-none block">
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="text-left">
                ...
                <div className="text-xs sm:text-sm font-bold text-gray-900">Technicians</div>
              </div>
            </div>
          </div>
          ...
          <div className="absolute bottom-[22.5%] sm:bottom-24 right-2 sm:right-1/4 bg-white/80 backdrop-blur-sm px-2 py-1.5 sm:px-4 sm:py-3 rounded-lg sm:rounded-xl shadow-md sm:shadow-lg border border-indigo-200/50 pointer-events-none block">
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <div className="text-left">
                <div className="text-[10px] sm:text-xs text-gray-500">90 Days</div>
                <div className="text-xs sm:text-sm font-bold text-gray-900">Warranty</div>
              </div>
            </div>
          </div>
            ...
            <div className="text-center lg:text-left space-y-3 sm:space-y-5 order-1 lg:order-1">
              <div className="space-y-2">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                  ...
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-purple-600">Apple Device </span>
                  <br />
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 leading-relaxed px-2 sm:px-0">
                Professional repairs for MacBook, iPhone, iPad, iMac & iWatch. Same-day service with genuine parts and expert care you can trust.
              </p>
      ...
      <div className="relative z-20 bg-white w-full">
        {/* About Section */}
        <div id="about" className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 pt-8 sm:pt-12 md:pt-16 mb-8 sm:mb-12 md:mb-16 scroll-mt-24 relative">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-10">
          <p className="text-violet-600 font-semibold text-xs sm:text-sm uppercase tracking-wider mb-2">We have 5+ years of experience</p>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4">Right Partner for your Device Repairs</h2>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <div className="lg:col-span-2 space-y-4 sm:space-y-5">
            <p className="text-sm sm:text-base md:text-lg leading-relaxed text-gray-600">
              At Mac Repair Center, we specialize in offering top-notch repair services for all Apple devices, including MacBook, iPhone, iMac, iPad, and iWatch. Whether it's a cracked screen, battery issue, or software trouble, we've got you covered with expert solutions and genuine parts. Trust us to restore your device to peak performance.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div className="group p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-violet-200 bg-gradient-to-br from-violet-50 to-purple-50">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Experience You Can Count On</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  With years of expertise in Apple device repairs, we've built a reputation for reliability and quality. From simple fixes to complex hardware issues, we handle it all with precision and care.
                </p>
              </div>
              ...
              <div className="group p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Quick and Reliable Support</h3>
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  Facing issues with your Apple device? Don't worry we're here to help! Our team provides fast and efficient repair services to get you back on track in no time. Your satisfaction is our priority.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-center mt-6 lg:mt-0">
            <div className="text-center p-6 sm:p-8 md:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-violet-600 to-purple-600 text-white shadow-xl shadow-violet-500/20 w-full max-w-xs">
              <div className="text-4xl sm:text-5xl md:text-6xl font-bold mb-2 sm:mb-3">4.5k</div>
              <p className="text-base sm:text-lg md:text-xl font-medium">Satisfied Clients</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* Services Section */}
      <div id="services" className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 mt-8 sm:mt-12 md:mt-16 scroll-mt-24 relative">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-10">
          <p className="text-violet-600 font-semibold text-xs uppercase tracking-wider mb-2">What We Offer</p>
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3">Wide Variety of Repair Services</h2>
          <p className="text-sm sm:text-base text-default-600 max-w-2xl mx-auto px-4">Specialized solutions for all your Apple device needs</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="group p-4 sm:p-6 rounded-2xl border border-violet-200 bg-gradient-to-br from-violet-50 to-purple-50">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Activation Unlock</h3>
            <p className="text-sm sm:text-base text-gray-600">Secure and seamless access to your Apple device with our specialized unlock services.</p>
          </div>
          ...
          <div className="group p-4 sm:p-6 rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-cyan-50">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Water Damage Restoration</h3>
            <p className="text-sm sm:text-base text-gray-600">Advanced restoration techniques to bring your water-damaged device back to life.</p>
          </div>
          ...
          <div className="group p-4 sm:p-6 rounded-2xl border border-red-200 bg-gradient-to-br from-red-50 to-orange-50">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Dead Motherboard Revival</h3>
            <p className="text-sm sm:text-base text-gray-600">Precision repair of non-functional motherboards, restoring full functionality.</p>
          </div>
          ...
          <div className="group p-4 sm:p-6 rounded-2xl border border-green-200 bg-gradient-to-br from-green-50 to-emerald-50">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Storage Upgrades</h3>
            <p className="text-sm sm:text-base text-gray-600">Upgrade or downgrade storage for all MacBook and iMac models to meet your needs.</p>
          </div>
          ...
          <div className="group p-4 sm:p-6 rounded-2xl border border-amber-200 bg-gradient-to-br from-amber-50 to-yellow-50">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900">Data Recovery</h3>
            <p className="text-sm sm:text-base text-gray-600">Recover critical data from your MacBook with our reliable recovery services.</p>
          </div>
          ...
          <div className="group p-4 sm:p-6 rounded-2xl border border-indigo-200 bg-gradient-to-br from-indigo-50 to-purple-50">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2 sm:mb-3 text-gray-900">MDM Lock Removal</h3>
            <p className="text-sm sm:text-base text-gray-600">Unlock MDM locks for T2 and M1/M2/M3 models with secure solutions.</p>
          </div>
        </div>
      </div>

      {/* Stats Section */}
      <div id="stats" className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 mt-8 sm:mt-12 md:mt-16 scroll-mt-24 relative">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <p className="text-violet-500 font-semibold text-xs uppercase tracking-wide mb-2">Numbers That Speak</p>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">Our Success in Numbers</h2>
          <p className="text-xs sm:text-sm md:text-base text-default-600 max-w-4xl mx-auto">
            At Mac Repair Center, we take pride in our journey of delivering high-quality repairs for Apple devices. Over the years, we've successfully repaired thousands of MacBooks, iPhones, iPads, and other Apple devices, earning the trust of over 240 satisfied clients. With more than 6,500 issues resolved, our expertise in solving complex device problems and using only genuine parts has made us a leader in the industry. We are committed to providing fast, reliable, and efficient service, helping our customers get their devices back in perfect working condition. Our success is built on precision, care, and a passion for restoring the best in technology.
          </p>
        </div>
        ...
        <div className="p-4 sm:p-6 md:p-8 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-violet-500/10 to-blue-500/10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-violet-500">4205+</h3>
              <p className="text-xs sm:text-sm md:text-base text-default-600 mt-1 sm:mt-2">Devices Repaired</p>
            </div>
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-violet-500">245+</h3>
              <p className="text-xs sm:text-sm md:text-base text-default-600 mt-1 sm:mt-2">Happy Clients</p>
            </div>
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-violet-500">3550+</h3>
              <p className="text-xs sm:text-sm md:text-base text-default-600 mt-1 sm:mt-2">Repairs Completed</p>
            </div>
            <div>
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-violet-500">6545+</h3>
              <p className="text-xs sm:text-sm md:text-base text-default-600 mt-1 sm:mt-2">Issues Resolved</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 mt-8 sm:mt-12 md:mt-16 relative">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3">How We Ensure Quality Repairs</h2>
          <p className="text-sm sm:text-base text-default-600">Our proven 8-step process for excellence</p>
        </div>
      ...
      {/* Client Testimonials */}
      <div id="testimonials" className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 mt-8 sm:mt-12 md:mt-16 scroll-mt-24 relative">
        ...
        <div className="text-center mb-6 sm:mb-8">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-2 sm:mb-3">Our Clients Feedback</h2>
          <p className="text-sm sm:text-base text-default-600">Hear what our satisfied customers have to say</p>
        </div>
      ...
      {/* Call to Action */}
      <div id="contact" className="w-full max-w-[1400px] mx-auto mt-8 sm:mt-12 md:mt-16 mb-8 sm:mb-12 md:mb-16 scroll-mt-24 relative px-4 sm:px-6">
        ...
        <div className="relative overflow-hidden p-6 sm:p-10 md:p-14 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 text-white text-center shadow-2xl">
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 w-48 h-48 sm:w-64 sm:h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2"></div>
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4">Ready to Restore Your Device?</h2>
            <p className="text-sm sm:text-base md:text-lg mb-6 sm:mb-8 max-w-2xl mx-auto opacity-95">Contact us 24/7 for fast and reliable Apple device repairs with genuine parts</p>
            <div className="flex gap-3 sm:gap-4 justify-center flex-wrap">
              ...
              >
                ...
                <span className="hidden sm:inline">Call {process.env.NEXT_PUBLIC_BUSINESS_PHONE || '+91-77000-44192'}</span>
      ...
      <Modal 
        ...
        classNames={{
          ...
          wrapper: "!p-0 sm:!p-4 items-stretch sm:items-center !justify-stretch sm:!justify-center",
          closeButton: "hover:bg-gray-100 active:bg-gray-200 text-gray-500 z-50",
            ...
            <div className="flex items-start gap-2 sm:gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs sm:text-base text-gray-600">
                  {isSuccess ? "We'll get back to you within 24 hours" : "Get your Apple device fixed by certified technicians"}
                </p>
              </div>
            </div>
          </ModalHeader>
                ...
                <div className="flex flex-col gap-2 w-full">
                  ...
                  <Dropdown>
                    <DropdownTrigger className="w-full">
                      ...
                      >
                        {devices.find(d => d.key === formData.device)?.label || "Select your device"}
                      </Button>
                    </DropdownTrigger>
                    <DropdownMenu 
                      aria-label="Device selection"
                      className="min-w-[500px]"
                      onAction={(key) => setFormData({...formData, device: key as string})}
                    >
                      {devices.map((device) => (
