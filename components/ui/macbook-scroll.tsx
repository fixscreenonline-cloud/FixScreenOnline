...
export const MacbookScroll = ({
  ...
  const translate = useTransform(scrollYProgress, [0, 1], [0, 650]);
  const rotate = useTransform(scrollYProgress, [0.1, 0.2, 0.5], [-28, -28, 0]);

  return (
    <div
      ref={localRef}
      className="flex shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100"
    >
      {/* Lid */}
      <Lid
        rotate={rotate}
